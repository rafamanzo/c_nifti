def initialize(nifti_image, previous_indexes=[], eager=false)
    ...
    # If the dimensions are (i,j,k,l) and we want the element at (x,y,z,w)
    # Its index is given by: x + y*i + z*(i*j) + w*(i*j*k)
